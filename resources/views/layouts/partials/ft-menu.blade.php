...
<a class='link link-hover mx-2 text-base' href="{{ Route('n-ch-en-accion') }}">Innovación Humana en Acción</a>

<a class='link link-hover mx-2 text-base' href="{{ Route('n-la-paz-2050') }}"> La Paz 2050</a>
